 ...
 * Generated at: 2020-05-11 05:28:17 UTC
...
public final class stu_005ftab_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("          <h4 class=\"panel-title\">学员管理</h4>\n");
      out.write("        </div>\n");
      out.write("        <!-- tab页面start-->\n");
      out.write("        <ul id=\"myTab\" class=\"nav nav-tabs\">\n");
      out.write("          <li class=\"active\"><a href=\"#tab_1\" data-type=\"1\" data-toggle=\"tab\">付费学员</a></li>\n");
      out.write("          <li><a href=\"#tab_2\" data-type=\"2\" data-toggle=\"tab\">免费学员</a></li>\n");
      out.write("        </ul>\n");
      ...
      out.write("                <input type=\"text\" class=\"form-control\"  style=\"width:220px;\" id=\"user_id\" placeholder=\"请输入账号\" />\n");
      out.write("              </div>\n");
      out.write("              <div class=\"form-group m-r-10\">\n");
      out.write("                <input type=\"text\" class=\"form-control\" style=\"width:220px;\" id=\"user_name\" placeholder=\"请输入昵称\" />\n");
      out.write("              </div>\n");
      out.write("              <div class=\"form-group  m-r-10\" >\n");
      out.write("                <div class=\"input-group\">\n");
      out.write("                  <input readonly=\"readonly\" class=\"form-control\" style=\"width:220px;\" id=\"regist_Time\" placeholder=\"注册日期\">\n");
      out.write("                      ");
      out.write("\n");
      out.write("                </div>\n");
      out.write("              </div>\n");
      out.write("              <div class=\"form-group  m-r-10\" >\n");
      out.write("                <div class=\"input-group\">\n");
      out.write("                  <input  readonly=\"readonly\" class=\"form-control\" style=\"width:220px;\" id=\"last_PayDate_time\" placeholder=\"最近一次付费日期\">\n");
      out.write("                     ");
      out.write("\n");
      out.write("                </div>\n");
      out.write("              </div>\n");
      ...
      out.write("                <th>最近一次付费日期</th>\n");
      out.write("                <th>来源渠道</th>\n");
      out.write("                <th>操作</th>\n");
      out.write("              </tr>\n");
      out.write("              </thead>\n");
      out.write("            </table>\n");
      ...
      out.write("<script>\n");
      out.write("  var stuTable ;\n");
      out.write("  var stuid = $('#myTab a:first').attr(\"data-type\");//默认的类型\n");
      out.write("  //Tab页切换\n");
      out.write("  $(function(){\n");
      out.write("    //初始化 默认第1项\n");
      ...
      out.write("      stuid = $(this).attr(\"data-type\");\n");
      out.write("      stuTable.ajax.reload();\n");
      out.write("    });\n");
      ...
      out.write("    stuTable =  $(\"#table-1\").DataTable({\n");
      ...
      out.write("      ajax:{\n");
      out.write("        \"url\":\"/stu/list\",\n");
      out.write("        \"type\": \"POST\",\n");
      out.write("        \"dataType\":\"json\",\n");
      out.write("        \"data\":function(d){\n");
      out.write("          //查询 赋值传参\n");
      out.write("          d.stuid=stuid;\n");
      out.write("          d.userid=$(\"#user_id\").val();\n");
      out.write("          d.username=$(\"#user_name\").val();\n");
      out.write("          d.registTime=$(\"#regist_Time\").val();\n");
      out.write("          d.lastPayDatetime=$(\"#last_PayDate_time\").val();\n");
      out.write("          d.currentTime = new Date();\n");
      out.write("        }\n");
      out.write("      },\n");
      out.write("      columns: [\n");
      ...
      out.write("        { \"data\": \"registTime\"},\n");
      out.write("        { \"data\": \"lastPayDatetime\"},\n");
      out.write("        { \"data\": \"registerType\",\"render\":function(data,type,row,meta){\n");
      out.write("          var dataTypes = {0:\"网站\",1:\"移动端(Android)\",2:\"移动端(IOS)\",3:\"微信小程序\"};\n");
      out.write("            return dataTypes[data];\n");
      out.write("        }},\n");
      ...
      out.write("  /**\n");
      out.write("   * 导出数据\n");
      out.write("   * @param aLink\n");
      out.write("   */\n");
      out.write("  function exportData(aLink) {\n");
      out.write("    layer.msg('数据正在导出中，可能需要等候3秒到1分钟...', {\n");
      out.write("      icon: 16\n");
      out.write("      ,time: 5000\n");
      ...
      out.write("\n");
      out.write("    var datas = {};\n");
      out.write("    datas.stuid=stuid;\n");
      out.write("    datas.userid=$(\"#user_id\").val();\n");
      out.write("    datas.username=$(\"#user_name\").val();\n");
      out.write("    datas.registTime=$(\"#regist_Time\").val();\n");
      out.write("    datas.lastPayDatetime=$(\"#last_PayDate_time\").val();\n");
      out.write("    datas.currentTime = new Date();\n");
      out.write("    datas.length = -1;\n");
      out.write("\n");
      out.write("    var separator = ',\\u200C';\n");
      out.write("    var htmlText = '账号,昵称,注册日期,最近一次付费日期,性别,QQ号';\n");
      out.write("\n");
      out.write("    $.ajax({\n");
      out.write("      url:\"/stu/export/csv/answers\",\n");
      out.write("      type:\"post\",\n");
      out.write("      dataType:\"json\",\n");
      ...
      out.write("          $.each(data.result, function (index,info) {\n");
      out.write("            htmlText += '\\n\\u200C'+info.userid+\n");
      out.write("                    separator+(info.username ? info.username : '')+\n");
      out.write("                    separator+moment(info.registTime).format('YYYY-MM-DD HH:mm:ss ')+\n");
      out.write("                    separator+moment(info.lastPayDatetime).format('YYYY-MM-DD HH:mm:ss ')+\n");
      out.write("                    separator+(info.sex == 0 ? '男' : '女')+\n");
      out.write("                    separator+(info.qqNum ? info.qqNum : '') +\n");
      out.write("                    separator;\n");
      out.write("          })\n");
      out.write("        }\n");
      out.write("      }\n");
      out.write("    })\n");
      out.write("\n");
      out.write("    aLink.download = $('#export').attr('download');\n");
      out.write("    var blob = new Blob([\"\\ufeff\", htmlText],{type: 'text/csv,charset=utf-8'});\n");
      out.write("    aLink.href = URL.createObjectURL(blob);\n");
      out.write("  }\n");
      out.write("\n");
      out.write("  /*日期*/\n");
      out.write("  //弹出日期\n");
      out.write("  bootstrapDateUtil.show(\"regist_Time\");\n");
      out.write("  bootstrapDateUtil.show(\"last_PayDate_time\");\n");
      out.write("\n");
      out.write("</script>\n");
      out.write("</body>\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/user/stu_tab.jsp(50,14) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f0.setName("stu:search:0");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/user/stu_tab.jsp(53,14) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f1.setName("stu:export:0");
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                <a class=\"btn btn-sm btn-primary\" id=\"export\" onclick=\"exportData(this);\" download=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pname}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
        out.write("管理系统-学员管理.csv\" href=\"#\">导出数据</a>\n");
        out.write("              ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/user/stu_tab.jsp(141,12) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f2.setName("stu:find:0");
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("            btn+='<button class=\"btn btn-sm btn-primary\" data-toggle=\"modal\"  onclick=\"forwardTab('+row.id+',\\''+row.userid+'\\');\" href=\"#stu-tab-alert\"  type=\"button\">查看</button>';\n");
        out.write("            ");
