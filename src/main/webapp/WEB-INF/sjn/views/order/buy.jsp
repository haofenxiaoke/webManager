...
<%--    <link rel="stylesheet" type="text/css" href="http://union.tenpay.com/bankList/css_col4.css"/>--%>
    ...
    <link rel="stylesheet" href="${basePath}/resources-sjn/order/css/buy.css"/>
    ...
    <script type="text/javascript" src="${basePath}/resources-sjn/course/js/buy.js"></script>
    <style>
...
<div class="buy-all">
    <div class="Made-nav">
        <a href="${basePath}/" style="padding-left: 0px;">首页</a> > <a href="${basePath}/vip">开通会员</a> > <a>订单支付</a>
    </div>
    <div class="buy-succeed content-m-top">
        <div class="buySucceed-left">
            <img src="${basePath}/resources-sjn/index/images/sjn_buy.png"/>
        </div>
    ...
    <div class="buy-bottom">
      ...
      <%--  <div class="terrace djyc">
        ...
        <div class="favorable-wai">
            <div class="favorable">
                <p class="favorable-title">优惠券支付</p>
                <p class="flexible"><a class="flexible-btn"style="background: url('/resources-sjn/order/images/jia.png') center center no-repeat;"></a><a
                        class="favorable-quantity"><span>${fn:length(voucherList)}</span>张优惠券可用</a></p>
                <div style="border: 1px solid #cccccc; margin-top: 15px; padding-bottom: 10px; display: none;"
                     class="contract">
                    <table class="watch-head" style="width: 100%; border-bottom: 1px solid #cccccc;">
                        <tr>
                            <td style="width: 8%; min-width: 8%; max-width: 8%;">选择</td>
                            <td style="width: 25%; min-width: 25%; max-width: 25%;">优惠券号</td>
                            <td style="width: 8%;min-width: 8%; max-width: 8%;">金额</td>
                            <td style="width: 29%; min-width: 29%; max-width: 29%;">券名</td>
                            <%--<td style="width: 9% min-width:9%; max-width: 9%;">券类型</td>--%>
                            <td style="width: 30%; min-width: 30%; max-width: 30%;">有效期</td>
                        </tr>
                    </table>
                                    ...
                                    <c:when test="${status.first}">
                                        <tr style="background: #fffdee;">
                                            ...
                                            <td id="<fmt:formatNumber type="number"   pattern="##.##" minFractionDigits="2" value="${voucher.price}" />"
                                                style="width: 8%;min-width: 8%; max-width: 8%;"><fmt:formatNumber
...
<div class="fkcg" id="pay-dialog">
    <div class="fknr">
        ...
        <div class="fktb">
            <img src="${basePath}/resources-sjn/order/images/money.png"/>
        </div>
...
<script type="text/javascript">
    ...
    $(".flexible-btn").click(function () {
        ...
        if (extyq % 2 == 0) {
            ...
            $(".flexible-btn").css("background", "url(../../../resources-sjn/order/images/jia.png) no-repeat center center");
        } else {
            $(".contract").slideDown("slow")
            $(".flexible-btn").css("background", "url(../../../resources-sjn/order/images/jian.png) no-repeat center center");
        }
        extyq++;
    });
...
$('.fknrgb').click(function(){
    $("#pay-refresh").css('display','none');
})
    if (orderVoucherNum != ''){
