...
<body>
                        ...
                        <div class="panel-body">
                            <div id="menuBody" class="row" style="display: none;">
                                <form id="menuForm" class="form-horizontal form-bordered" data-parsley-validate="true">
                                    ...
                                    <shiro:hasPermission name="menu:operManage:1">
                                    <div class="form-group" level="2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                           <shiro:hasPermission name="menu:update:1">
	    ...
	    <script src="${pageContext.request.contextPath}/resources/base/auth/js/menu.js"></script>
        <script src="${pageContext.request.contextPath}/resources/base/auth/js/oper.js"></script>
	    <script>
	    	$(document).ready(function() {
              //是否有查询菜单的权限
              <shiro:hasPermission name="menu:find:0">
