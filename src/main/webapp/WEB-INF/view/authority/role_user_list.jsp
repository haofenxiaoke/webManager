...
<div class="input-group">
    ...
    <div class="input-group-btn">
        <shiro:hasPermission name="role:userAuth:0">
            <button id="userAuth" onclick="saveAuthUser(this);" type="button" class="btn btn-success" style="width:126px;">授权</button>
        </shiro:hasPermission>
    </div>
    <div class="col-md-4">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-green">
                ...
                <div class="stats-link">
                    <shiro:hasPermission name="role:delRoleUser:0">
                     <a href="javascript:;" onclick="delRoleUser(${rid},${u.id});">删除用户</a>
                    </shiro:hasPermission>
                </div>
            </div>
        </div>
...
<script>
   $("#userEmail").autocomplete(path+"/role/user/email", {
        dataType: "json",
        max: 12,  //列表里的条目数
