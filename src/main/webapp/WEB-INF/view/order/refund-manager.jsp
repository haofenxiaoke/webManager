            ...
            <div class="row">
                ...
                <div class="tab-content">
                    <form id="search-form" class="form-inline">
                        ...
                        <shiro:hasPermission name="refund-manager:search:0">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer" id="modify-pass-btns" style="display: none">
                    <button type="button" id="modify-no-pass-btn" class="btn btn-danger">修改为不通过</button>
...
<div id="button-1">
    <shiro:hasPermission name="refund-manager:modify">
        <button type="button" class="btn btn-sm btn-danger" id="deleteLive" onclick="page.modifyAudit('#orderId','#id')">修改为不通过</button>
    </shiro:hasPermission>
</div>
<div id="button-2">
    <shiro:hasPermission name="refund-manager:audit">
...
<script src="${pageContext.request.contextPath}/resources/base/order/refund-manager.js"></script>
<script>
    $(function () {
        page.init();
    })
