...
<link rel="stylesheet" type="text/css" href="${basePath}/resources/userCenter/css/studySet.css?v=<%=System.currentTimeMillis() %>">
  ...
  <script src="${basePath}/resources/userCenter/js/safeSet.js"></script>
    ...
    <div class="userR-zccount">
      ...
      <div style="display: block;">
        <form id="userInfo-update-form">
            ...
            <div class="userR-tx clearfloat mt6">
            <label>头像：</label>
              <c:choose>
			...
			<div id="upload-span" style="font-size:12px; width:200px; margin-left:157px; margin-bottom: 10px;">
              <div id="queue"></div>

              <input id="file_upload" name="file_upload" type="file" multiple="true">
              <input type="hidden" id="head-image-path" name="imgurl" value="">
         	  
            </div>
				 <div class="geshi">
				 	仅支持jpg/png格式文件，大小须不超过5M
				 </div>
            	
          <div class="userR-data clearfloat mt6">
            <label>昵称：</label>
        ...
        <a class="btn90 mrl curNo" id="userInfo-update-btn1"  onclick="updateInfo(this)" style="margin-top: 35px;">保存修改</a>
      ...
      <div>
        ...
        <a href="javascript:void(0);" class="btn90 mrl curNo" id="pwd-update-btn" style="margin-top: 35px;">保存修改</a>
      </div>
    </div>
 </div>
</div>
      ...
      'onUploadSuccess': function (file, data, response) {// 上传成功后执行
        ...
        layer.open({
          ...
          yes: function (index) {
            ...
            if (destPath) {
              $('#preview-image').attr('src', destPath);
...
<div class="fxtc" id="upInfoTip" style="display: none;">
  <div class="undefined">
    <a>
      ...
      <span id="sucMessage" style="font-size: 18px;"></span>
    </a>
  </div>
</div>
...
<div class="fxtc" id="passTip" style="display: none;">
  <div class="undefined">
    <a>
      <img src="${basePath}/resources/course/images/fenxiang.png" />
      <span id="passSucMsg" style="font-size: 18px;"></span>
    </a>
  </div>
</div>
</body>
