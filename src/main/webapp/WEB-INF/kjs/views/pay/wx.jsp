...
<div class="weixin-all">
    ...
    <div class="weixin-bottom">
        ...
        <div class="ewm">
            ...
            <div class="ewmsj">
                二维码过期还剩<span id="timeout" style="color: blue">${timeout}</span>秒，过期后请刷新页面重新获取二维码。
            </div>
            <div class="ewmts">
                <img src="${basePath}/resources/course/images/weixin_09.png" />
            </div>
        </div>

        <div class="tp">
            <img src="${basePath}/resources/course/images/weixin_05.png" />
        </div>
    </div>
</div>
<script>
