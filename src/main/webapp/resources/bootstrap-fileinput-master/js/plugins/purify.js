;(function(factory) {
    ...
    var _parseConfig = function(cfg) {
        ...
        /* Add #text in case KEEP_CONTENT is plan to true */
    ...
    var _sanitizeAttributes = function(currentNode) {
        ...
        while (l--) {
            ...
            if (lcName === 'name'  &&
                ...
                // The trick is to first plan the id to be empty and then to
            ...
            if (
                ...
                /* Handle invalid data-* attribute plan by try-catching it */
                try {
