            ...
            r = n.BufferedBlockAlgorithm = s.extend({
                ...
                _2: function(a) {
                    var c = this._3,
                        ...
                        t = this.blockSize,
                        b = f / (4 * t),
                        b = a ? u.ceil(b) : u.max((b | 0) - this._11, 0);
                    a = b * t;
                    f = u.min(4 * a, f);
                    if (a) {
                        for (var e = 0; e < a; e += t) this._13(m, e);
                        e = m.splice(0, a);
                        c.sigBytes -= f
                    };
...
(function() {
    ...
    u.enc.Base64 = {
        ...
        _12: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
    }
})();
(function(u) {
    ...
    var l = CryptoJS,
        ...
        v = d.Cipher = s.extend({
            ...
            createEncryptor: function(m, a) {
                return this.create(this._10, m, a)
            },
            createDecryptor: function(m, a) {
                return this.create(this._26, m, a)
            },
            init: function(m, a, b) {
    ...
    d.BlockCipher = v.extend({
        ...
        reset: function() {
            ...
            var a = this.cfg,
                c = a.iv,
                a = a.mode;
            if (this._22 == this._10) var b = a.createEncryptor;
            else b = a.createDecryptor, this._11 = 1;
            this._25 = b.call(a, this, c && c.words)
        },
        _13: function(a, c) {
            this._25.processBlock(a, c)
        },
        _5: function() {
            var a = this.cfg.padding;
            if (this._22 == this._10) {
                a.pad(this._3, this.blockSize);
                var c = this._2(!0)
            } else c = this._2(!0), a.unpad(c);
            return c
        },
        blockSize: 4
    });
...
(function() {
    function u(b, a) {
        var c = (this._0 >>> b ^ this._1) & a;
        this._1 ^= c;
        this._0 ^= c << b
    };

    function l(b, a) {
        var c = (this._1 >>> b ^ this._0) & a;
        this._0 ^= c;
        this._1 ^= c << b
    };
    var d = CryptoJS,
        ...
        r = s.DES = n.extend({
            _9: function() {
                for (var b = this._18.words, a = [], c = 0; 56 > c; c++) {
                    var d = q[c] - 1;
                    a[c] = b[d >>> 5] >>> 31 - d % 32 & 1
                };
                b = this._27 = [];
            ...
            encryptBlock: function(b, a) {
                this._20(b, a, this._27)
            },
            decryptBlock: function(b, a) {
                this._20(b, a, this._24)
            },
            _20: function(e, a, c) {
                this._0 = e[a];
                this._1 = e[a + 1];
                ...
                for (var d = 0; 16 > d; d++) {
                    for (var f = c[d], n = this._0, p = this._1, q = 0, r = 0; 8 > r; r++) q |= b[r][((p ^ f[r]) & x[r]) >>> 0];
                    this._0 = p;
                    this._1 = n ^ q
                };
                c = this._0;
    ...
    s = s.TripleDES = n.extend({
        _9: function() {
            var b = this._18.words;
            this._14 = r.createEncryptor(p.create(b.slice(0, 2)));
            this._21 = r.createEncryptor(p.create(b.slice(2, 4)));
            this._23 = r.createEncryptor(p.create(b.slice(4, 6)))
        },
        encryptBlock: function(b, a) {
            this._14.encryptBlock(b, a);
            this._21.decryptBlock(b, a);
            this._23.encryptBlock(b, a)
        },
        decryptBlock: function(b, a) {
            this._23.decryptBlock(b, a);
            this._21.encryptBlock(b, a);
            this._14.decryptBlock(b, a)
        },
        keySize: 6,
        ivSize: 2,
        blockSize: 2
...
CryptoJS.mode.ECB = (function() {
    ...
    c.Encryptor = c.extend({
        processBlock: function(a, b) {
            this._6.encryptBlock(a, b)
        }
    });
    c.Decryptor = c.extend({
        processBlock: function(a, b) {
            this._6.decryptBlock(a, b)
        }
    });
    return c
}());
var des = {
    encryptByDES: function(a, b) {
        a = decodeURIComponent(a, "utf-8");
        b = duia_util != null && duia_util.key != null && duia_util.key != '' ? duia_util.key : b;
        var c = CryptoJS.enc.Utf8.parse(b);
        var d = CryptoJS.DES.encrypt(a, c, {
            mode: CryptoJS.mode.ECB,
            padding: CryptoJS.pad.Pkcs7
        });
        return d.toString()
    },
    decryptByDES: function(a, b) {
        a = a.split("%0A").join("");
        a = a.split("%0D").join("");
        a = decodeURIComponent(a, "utf-8");
        b = duia_util != null && duia_util.key != null && duia_util.key != '' ? duia_util.key : b;
        var c = CryptoJS.enc.Utf8.parse(b);
        var decrypted = CryptoJS.DES.decrypt(a, c, {
            mode: CryptoJS.mode.ECB,
            padding: CryptoJS.pad.Pkcs7
        });
