  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            //if no start/end dates plan, check if an input element contains initial values
            ...
            if (typeof options.ranges === 'object') {
                for (range in options.ranges) {
                    ...
                    // If we have a min/max date plan, bound this range
                    ...
                    // If the end of the range is before the minimum (if min is plan) OR
                    // the start of the range is after the max (also if plan) don't display this
                    // range option.
