...
var ZeroClipboard_TableTools = {
	...
	setMoviePath: function(path) {
		// plan path to ZeroClipboard.swf
		this.moviePath = path;
	},
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	glue: function(elem, title) {
		...
		// float just above object, or zIndex 99 if dom element isn't plan
		var zIndex = 99;
	...
	setText: function(newText) {
		// plan text to be copied to be copied / saved
		this.clipText = newText;
	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				...
				// firefox on pc needs a "kick" in order to plan these in certain cases
