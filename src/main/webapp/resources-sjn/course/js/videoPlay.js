...
$(".lr-top li").click(function(){
	...
	$(this).css({"border-bottom":"2px solid #e62c3a","color":"#e62c3a"}).siblings().css({"border-bottom":"0px","color":"#ffffff"})
...
$(".jdt-right li").click(function(){
	...
	$(".jdt-right li").eq(i).css("background","url(../../../resources-sjn/index/images/sp_xingxing.png) no-repeat center center");
...
$(".jdt-rightone li").click(function(){
	...
	$(".jdt-rightone li").eq(i).css("background","url(../../../resources-sjn/index/images/sp_xingxing.png) no-repeat center center");
