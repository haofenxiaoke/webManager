...
(function ($) {
    ...
    function bindEvents() {
        ...
        $('#register-modal-btn').click(function () {
            Util.Modal.show('/resources-sjn/modal/register.html');
        });
        //搜索按钮点击事件
        ...
        $.getJSON().done(function (result) {
            ...
            if(result.success()){
                ...
                $.each(result.data,function (key,course) {
                    ...
                    html+=' </div>';
                    html+=' <div class="kjsSmallj">学习了<span style="color: #e62c3a;">10</span>/26课程小节 </div>';
                    html+='</div>';
    ...
    function  old(){
        ...
        $('.kjsDlyd a').hover(function(){
            ...
            if(dataFlag=="1"){
                ...
                kjsJdCon = '<p>记录你点滴的成长<br/>成功路上设计牛一路相伴</p>';
            }else{
        ...
        //    $(this).find('i').css('background-position'," -96px -4px")
        //},function(){
        //    $(this).find('i').css('background-position'," -96px -29px")
        //})
        //$(".dlXj-num2").hover(function(){
        //    $(this).find('i').css('background-position',"  -66px -3px")
        //},function(){
        //    $(this).find('i').css('background-position'," -66px -29px")
        //})
        //$(".dlXj-num3").hover(function(){
        //    $(".kjsJdCon").css('top',0);
        //    $(this).find('i').css('background-position'," -36px -4px")
        //},function(){
        //    $(".kjsJdCon").css('top','58px');
        //    $(this).find('i').css('background-position'," -36px -29px")
        //})
        //$(".dlXj-num4").hover(function(){
        //    $(".kjsJdCon").css('top',0);
        //    $(this).find('i').css('background-position'," -5px -4px")
        //},function(){
        //    $(".kjsJdCon").css('top','58px');
        //    $(this).find('i').css('background-position'," -5px -29px")
        //})
