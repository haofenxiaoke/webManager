...
import com.kjs.service.kjs.authority.spi.*;
...
public class AuthorityRoleController {
    ...
    @Resource
    private IAuthorityUserRoleService authorityUserRoleService;
    ...
    public String listUserByRole(Model model,Long roleId){
    ...
    public ResponseJsonModel saveUserAuth(HttpServletRequest request, Long roleId, String email){
          ...
          if(CollectionUtils.isEmpty(users)||users.size()>1){
              responseModel.setCode(HttpConstant.ERROR_CODE);
