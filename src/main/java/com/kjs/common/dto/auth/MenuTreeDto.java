...
public class MenuTreeDto {
    ...
    public MenuTreeDto(Long id, String name, List<MenuTreeDto> children, boolean open,boolean parent,int enable,String code) {
        this.id = id;
        this.name = name;
    ...
    public MenuTreeDto(Long id, String name,boolean parent,String code) {
        this.id = id;
        this.name = name;
        this.parent = parent;
        this.code = code;
