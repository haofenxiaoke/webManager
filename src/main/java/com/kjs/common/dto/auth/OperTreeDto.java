...
public class OperTreeDto {
    ...
    public OperTreeDto(Long id, String name, String code, boolean open, boolean checked, boolean parent, List<OperTreeDto> children) {
        this.id = id;
        this.name = name;
        this.code = code;
        this.open = open;
    ...
    public OperTreeDto(Long id, String name,boolean parent) {
        this.id = id;
        this.name = name;
        this.parent = parent;
    }
